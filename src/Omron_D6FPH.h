...
public:
	Omron_D6FPH(void);
	boolean begin(TwoWire &wirePort = Wire, uint8_t deviceAddress = D6FPH_ADDRESS, sensorModels sensorModel = D6F_PH5050AD3);
    void setSensorModel(sensorModels sensorModel = D6F_PH5050AD3);
    boolean isConnected();
